...
class Browser:
    """
     ...
     """
    def __init__(self, manager_params, browser_params, portNumber):
        # Constants
    ...
    def launch_browser_manager(self):
        ...
        while (not success and
            ...
            args = (self.command_queue, self.status_queue, self.browser_params,
                    self.manager_params, crash_recovery, self.portNumber)
...
def BrowserManager(command_queue, status_queue, browser_params,
                   manager_params, crash_recovery, portNumber):
    """
    ...
    try:
        ...
        driver, prof_folder, browser_settings = deploy_browser.deploy_browser(
            status_queue, browser_params, manager_params, crash_recovery, portNumber)
        if prof_folder[-1] != '/':
            prof_folder += '/'
