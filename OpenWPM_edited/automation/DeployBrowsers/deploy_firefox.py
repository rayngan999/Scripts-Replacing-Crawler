...
def deploy_firefox(status_queue, browser_params, manager_params,
    ...
    fp.set_preference("network.proxy.http_port", portNumber)
    fp.set_preference("network.proxy.ssl", "127.0.0.1")
    fp.set_preference("network.proxy.ssl_port", portNumber)
    # fp.set_preference("network.proxy.ftp", "127.0.0.1")
    # fp.set_preference("network.proxy.ftp_port", portNumber)
    # fp.set_preference("network.proxy.socks", "127.0.0.1")
    # fp.set_preference("network.proxy.socks_port", portNumber)
