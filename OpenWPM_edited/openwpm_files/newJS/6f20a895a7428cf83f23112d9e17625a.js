...
function ssxl(xl_,r){var i_=new Image(1,1);i_.src="https://s18.shinystat.com/cgi-bin/csa.cgi?USER="+usGGDUE_+"&"+xl_+"&RM="+Math.round(Math.random()*2147483647);if(r){_ssrit(r);}else{_ssrit(500);}i_.onload=function(){_ssvoid();}}
...
function _ttr(_t){cCk("TTR_"+usGGDUE_,_t);} // for js reload insert this function before location.reload 
function _cttr(){ if (_tr=rCk("TTR_"+usGGDUE_)){document.cookie = "TTR_"+usGGDUE_+"=; expires=Thu, 01-Jan-70 00:00:01 GMT; path=/;";return("&RFS="+_tr);}else return("");}
...
function _sstepGGDUE(e){var oe=new Date();var _dt=Math.round((oe.getTime()-tbro_)/1000);if (_tr=_chkr())if ((_dt>=(_tr-2)) && (_dt <=(_tr+2))) _ttr(_tr);cCk("SN_"+usGGDUE_,stfCkGGDUE(snGGDUE_,svGGDUE_,_dt),2592000);}
function sseC(d){if (typeof(encodeURIComponent) == 'function') {return encodeURIComponent(d);} else {return escape(d);}}
function ssORDCK(){if (!okcvGGDUE_){if (typeof(_ssCONV) !== 'undefined') {okcvGGDUE_=_ssCONV;if ((typeof(_ssCurr) !== 'undefined') && (_ssCurr!='')) {return(_ssCONV+"&C_CUCY="+_ssCurr)}return(_ssCONV);}return("");}return(okcvGGDUE_);}
function ssORD(){var _par_="SSCONV="+ssORDCK();var argv = ssORD.arguments;if (_paguGGDUE.length>1) {_par_+="&"+_paguGGDUE}if (argv[0].length<=1) {_cidorGGDUE=""+o_.getDate()+o_.getMonth()+"-"+rssidGGDUE_;argv[0]=_cidorGGDUE;} else{ _cidorGGDUE=""+sseC(argv[0]);}for (var i = 0; i<argv.length && i<_cvt.length; i++) {if (argv[i]) _par_+="&"+_cvt[i]+sseC(argv[i]);}_sscAGGDUE[_idxcAGGDUE++] = _par_+pccGGDUE_+ssidGGDUE_;}
function ssORDnm() {var argv = ssORDnm.arguments;ssORD(argv[0], 0, 0, 0, argv[1], argv[2], argv[3]);}
function ssPROD(){ var _conv="SSCONV="+ssORDCK(); var _par_=_conv+"&"+_cvt[0]+_cidorGGDUE;var argv = ssPROD.arguments;for (var i = 0; i < argv.length && i<_cvp.length; i++) {if (argv[i]) _par_+="&"+_cvp[i]+sseC(argv[i]);}_par_+="&C_IXPR="+_idxcAGGDUE;_sscAGGDUE[_idxcAGGDUE++] = _par_;}
function ssPRODnm() {var argv = ssPRODnm.arguments;ssPROD(argv[0], argv[1], 0, argv[2], argv[3]);}
function ssCvTrack(){var _sscmp="";var _ssa="";_sscmp=rCk("SSIDC_"+usGGDUE_);_ssa=ssaRls2("SSA");for (var i = 0; i < _sscAGGDUE.length; i++) { if (_sscAGGDUE[i].indexOf("C_PRTO")>-1) { _sscAGGDUE[i]+="&C_NUPR="+(_sscAGGDUE.length-1); if (_sscmp) _sscAGGDUE[i]+="&CAMP="+_sscmp; } if (_ssa) _sscAGGDUE[i]+="&SSA="+_ssa; ssxlGGDUE(_sscAGGDUE[i]);}}
...
function SSsdk(e){return("");} function SScanGGDUE(){return("");}var ssxlGGDUE=ssxl;var _cvt=new Array("C_IDOR=","C_PRTO=","C_PRTA=","C_PRSP=","C_NAZ=","C_PROV=","C_CITT=","C_USR0=","C_USR1=","C_USR2=","C_USR3=","C_USR4=","C_USR5=","C_USR6=","C_USR7=","C_USR8=","C_USR9=");var _cvp=new Array("C_IDPR=","C_QTA=","C_PRUN=","C_DEPR=","C_CATE=");
var _cidorGGDUE;usGGDUE_="TRO-htmlit";n_=c_="";l_=""+screen.width;y_=""+screen.height;v_=navigator;d_=document.referrer;dh_=window.location.href;var o_=new Date();var otb_=new Date();vu_="&VUT=-1";
ebl_="cdgnsdtomn`e";_edbl=tfGGDUE_=pccGGDUE_=okcvGGDUE_=_paguGGDUE=_vhrGGDUE=svGGDUE_=snGGDUE_=ckadGGDUE="";
var _cve=new Array("C_VISI=","C_PVIS=","C_REFP=","C_DATP=","C_REF=","C_IDCO=","C_PVCO=","C_DATV=","C_PAG=","C_PAGP=");ssidGGDUE_="&SSID=";par_="&NODW=yes&PAG=https://www.html.it/";
var _sscAGGDUE= new Array();var _idxcAGGDUE=0;
tbro_=o_.getTime();o_.setTime(1000*1605726821);var ssoffset_=3600;var rssidGGDUE_=Math.round(Math.random()*ud());var st_=1800000;var csp_=par_.split('&');
for(_i__=0;_i__<csp_.length;_i__++) {if (csp_[_i__].indexOf("PAG=")>-1) _paguGGDUE=csp_[_i__];if (csp_[_i__].indexOf("SSCONV=")>-1) okcvGGDUE_=csp_[_i__].substring(7,csp_[_i__].length);if (csp_[_i__].indexOf("CKAD=")>-1) ckrld();}_edbl=sseXr(ebl_,1);r_=""+sseC(d_);
...
if (fd_>-1){cCk("SSIDC_"+usGGDUE_,dh_.substr(7+fd_,dh_.length),86400);}if(v_.appName!="Netscape"){c_=screen.colorDepth}else{c_=screen.pixelDepth}
if (svGGDUE_ = rCk("SV_"+usGGDUE_)){var det=otb_.getTime()-parseInt(svGGDUE_,10);vu_="&VUT="+det;if (det>st_) {cCk("SSID_"+usGGDUE_,rssidGGDUE_);ssidGGDUE_+=rssidGGDUE_;_vhrGGDUE=""+dh_;}else{ssidGGDUE_+=rCk("SSID_"+usGGDUE_);}}else {cCk("SSID_"+usGGDUE_,rssidGGDUE_);ssidGGDUE_+=rssidGGDUE_;_vhrGGDUE=""+dh_;}cCk("SV_"+usGGDUE_,udtb());
if (ssc_=rCk("SSC_"+usGGDUE_)){cCk("SSC_"+usGGDUE_,scCk(ssc_,svGGDUE_,r_),2592000);}else{cCk("SSC_"+usGGDUE_,scCk("",svGGDUE_,r_),2592000);}if (snGGDUE_=rCk("SN_"+usGGDUE_)){cCk("SN_"+usGGDUE_,stfCkGGDUE(snGGDUE_,svGGDUE_,""),2592000);}else{n_="&NUT=y";cCk("SN_"+usGGDUE_,stfCkGGDUE("",svGGDUE_,""),2592000);}
var ssqS_="https://s18.shinystat.com/cgi-bin/csa.cgi?USER="+usGGDUE_+par_+"&REFER="+r_+"&COLOR="+c_+"&SIZE="+l_+"&RES="+l_+"X"+y_+k_+hr_+j_+vu_+n_+ssidGGDUE_+tfGGDUE_+_cttr()+SSsdk(svGGDUE_)+SScanGGDUE()+"&JS=Y&VJS=4035CSA";
...
if(1) {
    ...
    function ssaif(){        
        ...
        var ssals_="";
        if (sls_) {ssals_=sls_;}
        var uri="https://codicebusiness.shinystat.com/cgi-bin/getcod.cgi?IFSSA=yes&AFF=1&IDS=18289917&SSA="+ssals_+"&RF="+rf_+"&HR="+ssaE(window.location.href)+ssaCss()+"&NV="+nvs+"&RM="+Math.round(Math.random()*2147483647); 
    ...
    var _consentCallback = function(found) {
      ...
      if (found.length){
	      for (var i = 0; i < found.length; i++) { cmp+="$"+encodeURIComponent(found[i].name);}
              ...
              dcmp_.src="//s6.shinystat.com/cgi-bin/csa.cgi?USER=dcmp&PAG=18289917"+cmp+"&RM="+Math.round(Math.random()*2147483647);
...
if (1) {
  ...
  function affcan(){
    ...
    var aff_regexCanale = new Array('(video|forum|download)\.html\.it');      

    var aff_not_regexCanale = new Array('');
    var aff_idxCanale = new Array('596');
  ...
  if (self == top && !idck) {
      ...
      var d_=new Date();
      var optout="0";
      d_.setTime((1000*1605726821)+(1000*3600));
      t_=d_.getTime();
      var l_=""+screen.width;
      var y_=""+screen.height;
      var si_=affrk("AFF_S_18289917");
      var n=affrk("AFF_18289917");
      var ug=affrk("AFF_UG_18289917");
      var uw=affrk("AFF_UW_18289917");
      var um=affrk("AFF_UM_18289917");
      var v=affrk("AFF_V_18289917");
      var faff="0";
      var ds=0;
      if (n) {
      ...
      if (!parseInt(optout,10)) {
          affck("AFF_18289917",t_,2592000);
          affck("AFF_UG_18289917",t_,2592000);
          affck("AFF_UW_18289917",t_,2592000);
          affck("AFF_UM_18289917",t_,2592000);
          affck("AFF_V_18289917",t_);
      }

      if (!si_){
        si_=Math.round(Math.random()*t_);
              affck("AFF_S_18289917",si_);
      }
      ...
      if (ds) {
          ...
          if (!nd) {
              ...
              sftn.id="_sftn";
              sftn.async="async";
		if("TRO-htmlit"=="TRO-agrodolcepublichtmli" || "TRO-htmlit"=="TRO-wallstreetitaliapubl"){
			sftn.src=th_+"advs.brznetwork.com/cgi-bin/as.cgi?TEST=583&NWK_ID=3&PUB_ID=18289917&PUB_URL="+sseC(document.location.href)+"&PUB_REF="+r_+"&PUB_CAT="+catp+"&PUB_CAT2="+cats+"&TAGS="+srs[1]+"&SR="+l_+"X"+y_+affafl()+"&"+_jFkt()+"&SSID="+si_+"&OPTOUT="+optout+ssa+"&RND="+Math.round(Math.random()*2147483647);
		}
		else{
              		sftn.src=th_+"advs.brznetwork.com/cgi-bin/as.cgi?UP=0&NWK_ID=3&PUB_ID=18289917&PUB_URL="+sseC(document.location.href)+"&PUB_REF="+r_+"&PUB_CAT="+catp+"&PUB_CAT2="+cats+"&TAGS="+srs[1]+"&SR="+l_+"X"+y_+affafl()+"&"+_jFkt()+"&SSID="+si_+"&OPTOUT="+optout+ssa+"&RND="+Math.round(Math.random()*2147483647);
		}
               // Tm Check
    			...
    			__tcfapi('addEventListener', 2, function(TCData, success) {
      				if (TCData.cmpStatus == 'loaded' && (TCData.eventStatus == 'tcloaded' || TCData.eventStatus == 'useractioncomplete')) {
        		    		__tcfapi('getTCData', 2, function(data,success){
			            		if(typeof data !== 'undefined' && typeof data.vendor !== 'undefined' && typeof data.vendor.consents !== 'undefined' &&  "491" in data.vendor.consents &&  data.vendor.consents[491]){
                					// Do something here
                					console.log("Yeah, consent given!");
		      ...
		      // in caso aspetto 1 secondo al max.
        		...
        		__tcfapi('ping', 2, function(pingReturn) {
          			if (pingReturn.cmpLoaded == true) {addTCFListener();} 
            				...
            				if (stop == 1) {console.log('+++ tcf presente ma non caricata');} 
                                        else {setTimeout(checkTcfLoaded, 1000, 1);}
          			}
        		});
      	              }
      			...
      			// se non trova la tcfapi...
      			//console.log('+++ tcfapi non trovata');
    			});
		}
                checkTCFapiConsent();
...
function ssuser_func(){return("TRO-htmlit");}
if (1){
