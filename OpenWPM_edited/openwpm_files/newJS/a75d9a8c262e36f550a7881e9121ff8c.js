 ...
 * https://modernizr.com/download/?-canvas-cookies-flexbox-touchevents-setclasses-cssclassprefix:supports- !*/
function enableFunctionCookie(){return enableCookie("^[^:]*1[^:]*:")}function enableAdvertisingCookie(){return enableCookie("^[^:]*2[^:]*:")}function enableCCM(){return!0}function enableCookie(a){if(!enableCCM())return!0;const b=getCookieByName("notice_gdpr_prefs"),c=new RegExp(a);return c.test(b)}function getCookieByName(a){for(var b=a+"=",c=decodeURIComponent(document.cookie),d=c.split(";"),e=0;e<d.length;e++){for(var f=d[e];" "==f.charAt(0);)f=f.substring(1);if(0==f.indexOf(b))return f.substring(b.length,f.length)}return""}function enableFunctionalExtention(){document.cookie="sat_track="+enableFunctionCookie()}!function(a,b,c){function d(a,b){return typeof a===b}function e(){return"function"!=typeof b.createElement?b.createElement(arguments[0]):w?b.createElementNS.call(b,"http://www.w3.org/2000/svg",arguments[0]):b.createElement.apply(b,arguments)}function f(){var a=b.body;return a||(a=e(w?"svg":"body"),a.fake=!0),a}function g(a,c,d,g){var h,i,j,k,l="modernizr",m=e("div"),n=f();if(parseInt(d,10))for(;d--;)j=e("div"),j.id=g?g[d]:l+(d+1),m.appendChild(j);return h=e("style"),h.type="text/css",h.id="s"+l,(n.fake?n:m).appendChild(h),n.appendChild(m),h.styleSheet?h.styleSheet.cssText=a:h.appendChild(b.createTextNode(a)),m.id=l,n.fake&&(n.style.background="",n.style.overflow="hidden",k=v.style.overflow,v.style.overflow="hidden",v.appendChild(n)),i=c(m,a),n.fake?(n.parentNode.removeChild(n),v.style.overflow=k,v.offsetHeight):m.parentNode.removeChild(m),!!i}function h(a,b){return!!~(""+a).indexOf(b)}function i(a){return a.replace(/([A-Z])/g,function(a,b){return"-"+b.toLowerCase()}).replace(/^ms-/,"-ms-")}function j(b,c,d){var e;if("getComputedStyle"in a){e=getComputedStyle.call(a,b,c);var f=a.console;if(null!==e)d&&(e=e.getPropertyValue(d));else if(f){var g=f.error?"error":"log";f[g].call(f,"getComputedStyle returning null, its possible modernizr test results are inaccurate")}}else e=!c&&b.currentStyle&&b.currentStyle[d];return e}function k(b,d){var e=b.length;if("CSS"in a&&"supports"in a.CSS){for(;e--;)if(a.CSS.supports(i(b[e]),d))return!0;return!1}if("CSSSupportsRule"in a){for(var f=[];e--;)f.push("("+i(b[e])+":"+d+")");return f=f.join(" or "),g("@supports ("+f+") { #modernizr { position: absolute; } }",function(a){return"absolute"===j(a,null,"position")})}return c}function l(a){return a.replace(/([a-z])-([a-z])/g,function(a,b,c){return b+c.toUpperCase()}).replace(/^-/,"")}function m(a,b,f,g){function i(){m&&(delete C.style,delete C.modElem)}if(g=!d(g,"undefined")&&g,!d(f,"undefined")){var j=k(a,f);if(!d(j,"undefined"))return j}for(var m,n,o,p,q,r=["modernizr","tspan","samp"];!C.style&&r.length;)m=!0,C.modElem=e(r.shift()),C.style=C.modElem.style;for(o=a.length,n=0;n<o;n++)if(p=a[n],q=C.style[p],h(p,"-")&&(p=l(p)),C.style[p]!==c){if(g||d(f,"undefined"))return i(),"pfx"!==b||p;try{C.style[p]=f}catch(a){}if(C.style[p]!==q)return i(),"pfx"!==b||p}return i(),!1}function n(a,b){return function(){return a.apply(b,arguments)}}function o(a,b,c){var e;for(var f in a)if(a[f]in b)return!1===c?a[f]:(e=b[a[f]],d(e,"function")?n(e,c||b):e);return!1}function p(a,b,c,e,f){var g=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+A.join(g+" ")+g).split(" ");return d(b,"string")||d(b,"undefined")?m(h,b,e,f):(h=(a+" "+D.join(g+" ")+g).split(" "),o(h,b,c))}function q(a,b,d){return p(a,c,c,b,d)}var r=[],s={_version:"3.8.0",_config:{classPrefix:"supports-",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(a,b){var c=this;setTimeout(function(){b(c[a])},0)},addTest:function(a,b,c){r.push({name:a,fn:b,options:c})},addAsyncTest:function(a){r.push({name:null,fn:a})}},t=function(){};t.prototype=s,t=new t;var u=[],v=b.documentElement,w="svg"===v.nodeName.toLowerCase();t.addTest("cookies",function(){try{b.cookie="cookietest=1";var a=-1!==b.cookie.indexOf("cookietest=");return b.cookie="cookietest=1; expires=Thu, 01-Jan-1970 00:00:01 GMT",a}catch(a){return!1}});var x=s._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];s._prefixes=x;var y=function(){var b=a.matchMedia||a.msMatchMedia;return b?function(a){var c=b(a);return c&&c.matches||!1}:function(b){var c=!1;return g("@media "+b+" { #modernizr { position: absolute; } }",function(b){c="absolute"===(a.getComputedStyle?a.getComputedStyle(b,null):b.currentStyle).position}),c}}();s.mq=y,t.addTest("touchevents",function(){if("ontouchstart"in a||a.TouchEvent||a.DocumentTouch&&b instanceof DocumentTouch)return!0;var c=["(",x.join("touch-enabled),("),"heartz",")"].join("");return y(c)}),t.addTest("canvas",function(){var a=e("canvas");return!(!a.getContext||!a.getContext("2d"))});var z="Moz O ms Webkit",A=s._config.usePrefixes?z.split(" "):[];s._cssomPrefixes=A;var B={elem:e("modernizr")};t._q.push(function(){delete B.elem});var C={style:B.elem.style};t._q.unshift(function(){delete C.style});var D=s._config.usePrefixes?z.toLowerCase().split(" "):[];s._domPrefixes=D,s.testAllProps=p,s.testAllProps=q,t.addTest("flexbox",q("flexBasis","1px",!0)),function(){var a,b,c,e,f,g,h;for(var i in r)if(r.hasOwnProperty(i)){if(a=[],b=r[i],b.name&&(a.push(b.name.toLowerCase()),b.options&&b.options.aliases&&b.options.aliases.length))for(c=0;c<b.options.aliases.length;c++)a.push(b.options.aliases[c].toLowerCase());for(e=d(b.fn,"function")?b.fn():b.fn,f=0;f<a.length;f++)g=a[f],h=g.split("."),1===h.length?t[h[0]]=e:(t[h[0]]&&(!t[h[0]]||t[h[0]]instanceof Boolean)||(t[h[0]]=new Boolean(t[h[0]])),t[h[0]][h[1]]=e),u.push((e?"":"no-")+h.join("-"))}}(),function(a){var b=v.className,c=t._config.classPrefix||"";if(w&&(b=b.baseVal),t._config.enableJSClass){var d=new RegExp("(^|\\s)"+c+"no-js(\\s|$)");b=b.replace(d,"$1"+c+"js$2")}t._config.enableClasses&&(a.length>0&&(b+=" "+c+a.join(" "+c)),w?v.className.baseVal=b:v.className=b)}(u),delete s.addTest,delete s.addAsyncTest;for(var E=0;E<t._q.length;E++)t._q[E]();a.Modernizr=t}(window,document),/*! =========================================================================
 * DELOITTE DIGITAL - HEAD
 * Tue Oct 20 2020 23:42:28 GMT+0700 (+07) (17d60efa08f62c80491fcc7877024b8aad88747d)
 * ==========================================================================
 */
window.DDIGITAL=window.DDIGITAL||{},function(){var a=function(){for(var a,b=3,c=document.createElement("div"),d=c.getElementsByTagName("i");c.innerHTML="<!--[if gt IE "+ ++b+"]><i></i><![endif]-->",d[0];);return b>4?b:a}(),b=document.documentElement;a&&(b.className+=" is-ie"),a<8&&(b.className+=" lt-ie8"),a<9&&(b.className+=" lt-ie9"),a<10&&(b.className+=" lt-ie10"),/MSIE 10/i.test(navigator.userAgent)&&(b.className+=" is-ie is-ie10"),/rv:11.0/i.test(navigator.userAgent)&&(b.className+=" is-ie is-ie11")}(),function(a){"use strict";var b={};a.i18n={set:function(a,c){b.hasOwnProperty(a)===!1&&(b[a]=c)},get:function(a,c){if(c=c||{},"[object Array]"===Object.prototype.toString.call(c)){var d={};c.forEach(function(a){d[a]="__"+a+"__"}),c=d}return b.hasOwnProperty(a)?jQuery.extend({},c,b[a]):c}}}(DDIGITAL),function(a){"use strict";a.util=a.util||{},a.util.cookie=function(){var a,b,c;return a=function(a,b,c,d,e){return!(!a&&!b)&&(0!==b.length&&(document.cookie=b+"="+a+(c?"; domain="+c:"")+(d?"; path="+d:"")+(e?"; expires="+e:""),!0))},b=function(a){for(var b=a+"=",c=document.cookie.split(";"),d=0;d<c.length;d+=1){for(var e=c[d];" "===e.charAt(0);)e=e.substring(1,e.length);if(0===e.indexOf(b))return e.substring(b.length,e.length)}return null},c=function(c,d,e){return!!b(c)&&(a("",c,d,e,"Thu, 01 Jan 1970 00:00:00 GMT"),!0)},{set:a,get:b,"delete":c}}()}(DDIGITAL),function(a){var b=[],c=!1;a.ready=function(a){"function"==typeof a&&(c?a():b.push(a))},a.triggerReady=function(){for(c=!0;b.length;)b.shift().call()}}(DDIGITAL),function(a){"use strict";var b=!1;try{b=Modernizr.cookies}catch(c){}a.isUserFromChina=function(){return!1}}(DDIGITAL),enableFunctionalExtention();
/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-adownload-ambientlight-animation-apng-appearance-applicationcache-audio-audioloop-audiopreload-backdropfilter-backgroundblendmode-backgroundcliptext-backgroundsize-batteryapi-bdi-beacon-bgpositionshorthand-bgpositionxy-bgsizecover-blobconstructor-bloburls-blobworkers-borderimage-borderradius-boxshadow-boxsizing-canvas-canvasblending-canvastext-capture-checked-classlist-contains-contenteditable-contextmenu-cookies-cors-cryptography-cssall-cssanimations-csscalc-csschunit-csscolumns-cssescape-cssexunit-cssfilters-cssgradients-csshairline-cssinvalid-cssmask-csspointerevents-csspositionsticky-csspseudoanimations-csspseudotransitions-cssreflections-cssremunit-cssresize-cssscrollbar-csstransforms-csstransforms3d-csstransitions-cssvalid-cssvhunit-cssvmaxunit-cssvminunit-cssvwunit-cubicbezierrange-customevent-customprotocolhandler-dart-datachannel-datalistelem-dataset-datauri-dataview-dataworkers-details-directory-display_runin-displaytable-documentfragment-ellipsis-emoji-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-es6array-es6collections-es6math-es6number-es6object-es6string-eventlistener-eventsource-exiforientation-fetch-fileinput-filereader-filesystem-flash-flexbox-flexboxlegacy-flexboxtweener-flexwrap-fontface-forcetouch-formattribute-formvalidation-framed-fullscreen-gamepads-generatedcontent-generators-geolocation-getrandomvalues-getusermedia-hashchange-hidden-hiddenscroll-history-hsla-htmlimports-ie8compat-imgcrossorigin-indexeddb-indexeddbblob-inlinesvg-input-inputformaction-inputformenctype-inputformmethod-inputformtarget-inputtypes-intl-jpeg2000-jpegxr-json-lastchild-ligatures-localizednumber-localstorage-lowbandwidth-lowbattery-matchmedia-mathml-mediaqueries-microdata-multiplebgs-mutationobserver-notification-nthchild-objectfit-olreversed-oninput-opacity-outputelem-overflowscrolling-pagevisibility-peerconnection-performance-picture-placeholder-pointerevents-pointerlock-postmessage-preserve3d-promises-proximity-queryselector-quotamanagement-regions-requestanimationframe-requestautocomplete-rgba-ruby-sandbox-scriptasync-scriptdefer-scrollsnappoints-seamless-search-serviceworker-sessionstorage-shapes-sharedworkers-siblinggeneral-sizes-smil-speechrecognition-speechsynthesis-srcdoc-srcset-strictmode-stylescoped-subpixelfont-supports-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-target-template-templatestrings-textalignlast-textareamaxlength-textshadow-time-touchevents-transferables-typedarrays-unicode-unicoderange-unknownelements-urlparser-userdata-userselect-vibrate-video-videoautoplay-videoloop-videopreload-vml-webaudio-webgl-webglextensions-webintents-webp-webpalpha-webpanimation-websockets-websocketsbinary-websqldatabase-webworkers-willchange-wrapflow-xdomainrequest-xhr2-xhrresponsetype-xhrresponsetypearraybuffer-xhrresponsetypeblob-xhrresponsetypedocument-xhrresponsetypejson-xhrresponsetypetext-setclasses-dontmin-cssclassprefix:supports-
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
