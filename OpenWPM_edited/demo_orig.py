...
# sites = ['https://us.trip.com/?locale=en_us','https://us.trip.com/?locale=en_us']
sites = ['http://yahoo.com/']
...
for i in range(NUM_BROWSERS):
    ...
    # browser_params[i]['profile_archive_dir'] = "./profiles"
    browser_params[i]['profile_tar'] = "./profiles"

# Update TaskManager configuration (use this for crawl-wide settings)
manager_params['data_directory'] = '~/Desktop/openWPM_data'
manager_params['log_directory'] = '~/Desktop/openWPM_data'
...
for site in sites:
    ...
    command_sequence.get(sleep=100, timeout=100)
